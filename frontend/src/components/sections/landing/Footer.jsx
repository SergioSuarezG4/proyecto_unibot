    ...
    <footer className="bg-[#1a2a29] text-[#a8c8c5] py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed mt-4">
              Plataforma académica creada por <span className="font-bold">Sergio Suárez y Sebastian Suárez</span>.
        ...
        <div className="border-t border-border pt-8 text-sm text-center md:text-left">
          <p>&copy; 2025 UniBot • Creado por Sergio Suárez Y Sebastian Suárez</p>
        </div>
